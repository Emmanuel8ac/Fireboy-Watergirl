package Box2D.Common.Math
{
   public class b2Math
   {
      ...
      public static function b2MulTMM(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         ...
         _loc3_ = new b2Vec2(b2Dot(param1.col1,param2.col1),b2Dot(param1.col2,param2.col1));
         _loc4_ = new b2Vec2(b2Dot(param1.col1,param2.col2),b2Dot(param1.col2,param2.col2));
