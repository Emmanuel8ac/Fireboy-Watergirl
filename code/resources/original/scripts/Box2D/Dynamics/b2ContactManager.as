package Box2D.Dynamics
{
   ...
   public class b2ContactManager extends b2PairCallback
   {
      ...
      override public function PairAdded(param1:*, param2:*) : *
      {
         ...
         _loc7_ = b2Contact.Create(_loc3_,_loc4_,m_world.m_blockAllocator);
         if(_loc7_ == null)
         {
            return m_nullContact;
         }
      ...
      public function Destroy(param1:b2Contact) : void
      {
         ...
         _loc4_ = param1.m_manifoldCount;
         if(_loc4_ > 0 && Boolean(m_world.m_contactListener))
         {
