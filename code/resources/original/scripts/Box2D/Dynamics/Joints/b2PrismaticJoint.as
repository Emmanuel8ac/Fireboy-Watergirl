package Box2D.Dynamics.Joints
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      public function GetJointTranslation() : Number
      {
         ...
         _loc5_ = _loc2_.GetWorldPoint(m_localAnchor2);
         _loc6_ = _loc5_.x - _loc4_.x;
         _loc7_ = _loc5_.y - _loc4_.y;
         _loc8_ = _loc1_.GetWorldVector(m_localXAxis1);
      ...
      override public function SolvePositionConstraints() : Boolean
      {
         ...
         _loc9_ = _loc3_.m_xf.R;
         _loc21_ = _loc9_.col1.x * m_localYAxis1.x + _loc9_.col2.x * m_localYAxis1.y;
         ...
         if(m_enableLimit && m_limitState != e_inactiveLimit)
         {
            ...
            _loc20_ = _loc18_ - _loc16_;
            _loc9_ = _loc3_.m_xf.R;
            _loc29_ = _loc9_.col1.x * m_localXAxis1.x + _loc9_.col2.x * m_localXAxis1.y;
      ...
      override public function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc4_ = _loc2_.m_xf.R;
         _loc14_ = _loc4_.col1.x * m_localYAxis1.x + _loc4_.col2.x * m_localYAxis1.y;
         ...
         {
            _loc4_ = _loc2_.m_xf.R;
            _loc18_ = _loc4_.col1.x * m_localXAxis1.x + _loc4_.col2.x * m_localXAxis1.y;
