package Box2D.Collision
{
   ...
   public class b2BroadPhase
   {
      ...
      public function b2BroadPhase(param1:b2AABB, param2:b2PairCallback)
      {
         ...
         _loc6_ = new b2Proxy();
         m_proxyPool[int(b2Settings.b2_maxProxies - 1)] = _loc6_;
      ...
      private function Query(param1:Array, param2:Array, param3:uint, param4:uint, param5:Array, param6:uint, param7:int) : void
      {
         ...
         _loc8_ = BinarySearch(param5,param6,param3);
         _loc9_ = BinarySearch(param5,param6,param4);
         _loc11_ = _loc8_;
         while(_loc11_ < _loc9_)
         {
            ...
            if(_loc10_.IsLower())
            {
               IncrementOverlapCount(_loc10_.proxyId);
            }
            _loc11_++;
         }
         if(_loc8_ > 0)
      ...
      public function DestroyProxy(param1:uint) : void
      {
         ...
         while(_loc6_ < 2)
         {
            ...
            Query([0],[0],_loc11_,_loc12_,_loc8_,_loc5_ - 2,_loc6_);
            _loc6_++;
         }
         _loc7_ = 0;
         while(_loc7_ < m_queryResultCount)
         {
            m_pairManager.RemoveBufferedPair(param1,m_queryResults[_loc7_]);
            _loc7_++;
         }
         m_pairManager.Commit();
         m_queryResultCount = 0;
      ...
      public function MoveProxy(param1:uint, param2:b2AABB) : void
      {
         ...
         var _loc14_:b2BoundValues = null;
         var _loc15_:b2BoundValues = null;
         var _loc16_:Array = null;
         var _loc17_:uint = 0;
         var _loc18_:uint = 0;
         var _loc19_:uint = 0;
         ...
         _loc12_ = 2 * m_proxyCount;
         _loc13_ = m_proxyPool[param1];
         _loc14_ = new b2BoundValues();
         ComputeBounds(_loc14_.lowerValues,_loc14_.upperValues,param2);
         _loc15_ = new b2BoundValues();
         _loc5_ = 0;
         while(_loc5_ < 2)
         {
         ...
         while(_loc5_ < 2)
         {
            ...
            if(_loc21_ < 0)
            {
               ...
               while(_loc6_ > 0 && _loc19_ < (_loc16_[int(_loc6_ - 1)] as b2Bound).value)
               {
                  ...
                  if(_loc8_.IsUpper() == true)
                  {
                     ...
                     {
                        m_pairManager.AddBufferedPair(param1,_loc23_);
                     }
            ...
            if(_loc21_ > 0)
            {
               ...
               while(_loc6_ < _loc12_ - 1 && (_loc16_[int(_loc6_ + 1)] as b2Bound).value <= _loc19_)
               {
                  ...
                  if(_loc9_.IsUpper())
                  {
                     if(TestOverlap(_loc15_,_loc11_))
                     {
            ...
            if(_loc22_ < 0)
            {
               ...
               while(_loc6_ > 0 && _loc20_ < (_loc16_[int(_loc6_ - 1)] as b2Bound).value)
               {
                  ...
                  {
                     if(TestOverlap(_loc15_,_loc24_))
                     {
                        m_pairManager.RemoveBufferedPair(param1,_loc23_);
                     }
                     _loc3_ = _loc24_.lowerBounds;
                     _loc4_ = int(_loc3_[_loc5_]);
                     _loc4_ = _loc4_ + 1;
