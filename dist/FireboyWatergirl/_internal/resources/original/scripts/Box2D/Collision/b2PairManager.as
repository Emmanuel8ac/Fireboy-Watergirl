package Box2D.Collision
{
   ...
   public class b2PairManager
   {
      ...
      {
         var _loc3_:uint = 0;
         _loc3_ = uint(param2 << 16 & 0xFFFF0000 | param1);
         _loc3_ = ~_loc3_ + (_loc3_ << 15 & 0xFFFF8000);
         _loc3_ ^= _loc3_ >> 12 & 0x0FFFFF;
         _loc3_ += _loc3_ << 2 & 0xFFFFFFFC;
      ...
      public function Commit() : void
      {
         ...
         while(_loc2_ < m_pairBufferCount)
         {
            ...
            _loc5_ = Find(_loc1_.proxyId1,_loc1_.proxyId2);
      ...
      private function AddPair(param1:uint, param2:uint) : b2Pair
      {
         ...
         _loc3_ = uint(Hash(param1,param2) & b2Pair.b2_tableMask);
         _loc4_ = _loc4_ = FindHash(param1,param2,_loc3_);
         if(_loc4_ != null)
         {
            return _loc4_;
         }
