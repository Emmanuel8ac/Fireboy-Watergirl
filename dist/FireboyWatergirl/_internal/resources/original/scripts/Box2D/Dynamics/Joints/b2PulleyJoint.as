   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      override public function SolvePositionConstraints() : Boolean
      {
         ...
         if(m_state == e_atUpperLimit)
         {
            ...
            _loc19_ = m_positionImpulse - _loc20_;
         ...
         if(m_limitState1 == e_atUpperLimit)
         {
            ...
            _loc19_ = m_limitPositionImpulse1 - _loc21_;
            _loc12_ = -_loc19_ * m_u1.x;
            _loc13_ = -_loc19_ * m_u1.y;
            _loc1_.m_sweep.c.x += _loc1_.m_invMass * _loc12_;
            _loc1_.m_sweep.c.y += _loc1_.m_invMass * _loc13_;
         ...
         if(m_limitState2 == e_atUpperLimit)
         {
            ...
            _loc19_ = m_limitPositionImpulse2 - _loc21_;
      ...
      override public function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc20_ = m_constant - _loc18_ - m_ratio * _loc19_;
         if(_loc20_ > 0)
         {
